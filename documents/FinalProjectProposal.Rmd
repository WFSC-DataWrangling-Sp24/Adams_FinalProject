...
1.  What data are you planning to use for the final project? Describe the data: its contents, its format(s), one or more dataframes, etc. If you have a link to the dataset, please include it. If you have a file that you can upload, please add it to the assignment submission.
  ...
  I plan to use the "College Basketball Dataset" from kaggle.com. It is 11 .csv files that contain information on each of the college basketball teams in the US. It contains info like seed, shooting percentages, location, etc. Link is here: [College Basketball Data](https://www.https://www.kaggle.com/datasets/andrewsundberg/college-basketball-dataset?resource=download). I will also upload the folder with all the .csv files. 
  
2.  Does this data need to be cleaned in any way to make it tidy? If so, what needs to occur?

  This data looks pretty good, with a usability rating of 10.0 on Kaggle. From what I can see, it looks pretty tidy, the classes of each column are correct, it all seems good!
...
*Answer*:
So far this course has been pretty straightforward. I really appreciate Dr. Bledsoe's thoroughness in her lessons--even though I have taken a few data science classes before I feel like I am learning more information each class we have. I am especially enjoying learning about Git and GitHub as none of my previous classes have touched on this and I'm realizing that version control is a very valuable process to learn how to do! I also appreciate the flexibility of the final project; I love being able to choose our own data source. Sometimes I get bogged down in using ecological/environmental data and get really excited to explore completely random, off-topic datasets! Thank you! 
